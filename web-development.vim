...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/ack,~/.vim/bundle/command-t,~/.vim/bundle/emmet-vim,~/.vim/bundle/fugitive,~/.vim/bundle/FuzzyFinder,~/.vim/bundle/git,~/.vim/bundle/gundo,~/.vim/bundle/L9,~/.vim/bundle/makegreen,~/.vim/bundle/minibufexpl,~/.vim/bundle/nerdtree,~/.vim/bundle/pep8,~/.vim/bundle/py.test,~/.vim/bundle/pydoc,~/.vim/bundle/ropevim,~/.vim/bundle/snipmate,~/.vim/bundle/sparkup,~/.vim/bundle/supertab,~/.vim/bundle/surround,~/.vim/bundle/vim-colors-solarized,~/.vim/bundle/vim-easymotion,~/.vim/bundle/vim-fugitive,~/.vim/bundle/vim-markdown,~/.vim/bundle/vim-rails,~/.vim/bundle/vim-sensible,~/.vim/bundle/vundle,/Applications/MacVim.app/Contents/Resources/vim/vimfiles,/Applications/MacVim.app/Contents/Resources/vim/runtime,/Applications/MacVim.app/Contents/Resources/vim/vimfiles/after,~/.vim/bundle/snipmate/after,~/.vim/bundle/vim-markdown/after,~/.vim/after
set scrolloff=1
set shiftround
set shiftwidth=2
set showcmd
...
silent only
cd ~/Documents/8.MOOC/nd000/ryan-intro-programming-project/project
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +2 ~/Documents/8.MOOC/nd000/ryan-intro-programming-project/project/web-development.html
badd +9 ~/Documents/8.MOOC/nd000/ryan-intro-programming-project/project/style.css
args web-development.html
edit ~/Documents/8.MOOC/nd000/ryan-intro-programming-project/project/web-development.html
...
exe '3resize ' . ((&lines * 30 + 17) / 34)
exe 'vert 3resize ' . ((&columns * 60 + 60) / 121)
argglobal
enew
file ~/Documents/8.MOOC/nd000/ryan-intro-programming-project/project/-MiniBufExplorer-
let s:cpo_save=&cpo
set cpo&vim
...
17
normal! zo
let s:l = 25 - ((12 * winheight(0) + 15) / 30)
...
wincmd w
argglobal
edit ~/Documents/8.MOOC/nd000/ryan-intro-programming-project/project/style.css
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 229 - ((25 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
229
